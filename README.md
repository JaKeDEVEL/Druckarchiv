...
**Current release: v0.8.7 — [download installers for macOS, Windows, and Linux](https://github.com/JaKeDEVEL/Druckarchiv/releases/latest).**
...
**Aktuelle Version: v0.8.7 — [Installer für macOS, Windows und Linux herunterladen](https://github.com/JaKeDEVEL/Druckarchiv/releases/latest).**
